...
#define API "wasapi"
#define NAME_ "SRT SERVER CALLER"
...
bool MyApp::OnInit()
{
    ...
    MyFrame* frame = new MyFrame(NAME_);
    frame->Show(true);
...
void MyFrame::OnStart(wxCommandEvent& WXUNUSED(event))
{
    ...
    config->mode = (int*)malloc(100 * sizeof(int));
    ...
    strcpy_s(config->uri, 100, wxString::Format("srt://10.13.24.30:%s", this->portTextCtrl->GetValue().c_str()));
